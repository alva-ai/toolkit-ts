...
export class AlvaClient {
  ...
  get markets(): MarketsResource {
    return (this._markets ??= new MarketsResource(this));
  }
  get tradingPairs(): TradingPairsResource {
    return (this._tradingPairs ??= new TradingPairsResource(this));
  }
